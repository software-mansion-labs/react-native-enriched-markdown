...
| `allowTrailingMargin` | `boolean` | `false` | When true, preserves the bottom margin of the last block element. When false, trailing margin is removed for tighter layout |
